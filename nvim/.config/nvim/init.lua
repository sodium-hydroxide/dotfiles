...
function VI.options.setup()
  ...
  vim.g.sleuth_excluded_filetypes = { "tex", "latex" }
end
...
function VI.plugins.setup()
  return {
    VI.plugins.config.vim_sleuth(),    -- Detect tabstop and shiftwidth automatically
    VI.plugins.config.gitsigns(),      -- Show sings for git
    VI.plugins.config.which_key(),     -- which-key Useful plugin to show you pending keybinds.
    VI.plugins.config.conform(),       -- Autoformatter
    -- VI.plugins.config.telescope(),     -- telescope Fuzzy Finder (files, lsp, etc)
    VI.plugins.config.nvim_tree(),     -- nvim-tree
    VI.plugins.config.toggleterm(),    -- terminal emulator
    VI.plugins.config.lazydev(),       -- add nvim info to lua lsp
    VI.plugins.config.lspconfig(),     -- main lsp configuration
    VI.plugins.config.nvimcpm(),       -- code completion
    VI.plugins.config.todo_comments(), -- highlight todo
    VI.plugins.config.mini_nvim(),     -- status line
    VI.plugins.config.treesitter(),    -- syntax highlighter
  }
end
